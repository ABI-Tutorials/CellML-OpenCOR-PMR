...
+----------------------+----------+----------------------+----------+----------------------+----------+------------------------------------+----------+-----------------------------------+----------+----------------------+----------+
| :math:`\sinh^{-1} x` | asinh(x) | :math:`\cosh^{-1} x` | acosh(x) | :math:`\tanh^{-1} x` | atanh(x) | :math:`\operatorname{csch}^{-1} x` | acsch(x) | :math:`\operatorname{sech}^{-1}x` | asech(x) | :math:`\coth^{-1} x` | acoth(x) |
+----------------------+----------+----------------------+----------+----------------------+----------+------------------------------------+----------+-----------------------------------+----------+----------------------+----------+
